            ...
            if tracking_started:
                ...
                for person in tracked_people:
                    ...
                    if arrow_coords['points'][1][1] < 0 and prev_cy > zipline_y and cy < zipline_y:
                        people_count += 1
                        publish_message("person_crossed_up", rtsp_url, site_id, camera_id, alarm_id, people_count)
                    ...
                    # If the arrow points down (arrow_end is below arrow_start), detect crossing downwards
                        ...
                        people_count += 1
                        publish_message("person_crossed_down", rtsp_url, site_id, camera_id, alarm_id, people_count)
